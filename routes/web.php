...
Route::group(["middleware" => "adminUtama"], function(){
    Route::resource("informasiToko", "InformasiTokoController");
    Route::resource("users", "UserController");
});
Route::group(["middleware" => "adminGudang"], function(){
    Route::resource("currencies", "CurrencyController");
    Route::resource("ppn", "PpnController");
    Route::resource("units", "UnitController");
    Route::resource("presentaseKeuntungan", "PresentaseKeuntunganController");
